      ...
      <div className="max-w-7xl mx-auto px-6 pt-12">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <aside className="w-full lg:w-72 bg-[#FAFAFA] p-8 rounded-[30px] border border-[#EEEEEE] space-y-12 shadow-sm">
            ...
            {/* Filter by Price */}
            <div>
              <h2 className="text-black text-2xl font-bold mb-3">Filter by price</h2>
              <div className="flex justify-between text-sm text-black mb-2">
                <span>$0</span>
                <span>$200</span>
              </div>
              <SliderWithBadge min={0} max={200} value={price} onChange={setPrice} isPrice />
            </div>

            {/* Filter by Promotions */}
            <div>
              <h2 className="text-black text-2xl font-bold mb-3">Filter by promotions</h2>
              <div className="flex justify-between text-sm text-black mb-2">
              <span>$0</span>
              <span>$200</span>
              </div>
              <SliderWithBadge min={0} max={100} value={promotion} onChange={setPromotion} />
            </div>
          </aside>
